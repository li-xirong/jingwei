...
from basic.common import ROOT_PATH, niceNumber,printStatus, writeRankingResults
from basic.annotationtable import readConcepts,readAnnotationsFrom
from basic.metric import getScorer
from basic.util import readImageSet


INFO = 'eval_pickle_save'
...
def main(argv=None):
    ...
    parser = OptionParser(usage="""usage: %prog [options] collection annotationName runfile outDirectory""")
