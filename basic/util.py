...
from common import readRankingResults,printError, printStatus
from constant import ROOT_PATH
import bisect

def getVocabMap(sVocab, dVocab):
    mapping = []
    for l in dVocab:
        try:
            idx = sVocab.index(l)
...
if __name__ == '__main__':
   ...
   for tag in str.split('dog car'):
       hitset = readLabeledImageSet(collection, tag)
